                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex gap-2">
                                            <select
                                                ...
                                                className="flex-1 bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-1 focus:ring-[#29258D] focus:border-[#29258D] transition-all shadow-none"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="p-2 border border-gray-200 rounded-lg text-[#29258D] hover:bg-gray-50 transition-colors"
                                    ...
                                    {items.map((item, index) => (
                                        <div key={index} className="flex flex-col md:flex-row gap-4 p-4 bg-white hover:bg-gray-50/50 transition-colors border-b border-gray-50 last:border-0 relative">
                                            <div className="flex-1">
                                                <input
                                                    className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-sm font-medium focus:outline-none focus:ring-1 focus:ring-[#29258D] focus:border-[#29258D] text-gray-900 placeholder:text-gray-400 transition-all"
                                            ...
                                            <div className="w-full md:w-48 relative">
                                                <div
                                                    className="flex items-center justify-between cursor-pointer bg-white border border-gray-200 rounded-xl px-4 py-3 transition-all hover:border-[#29258D]/30 focus-within:ring-1 focus-within:ring-[#29258D] focus-within:border-[#29258D]"
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                            ...
                                            <div className="w-full md:w-40 flex items-center gap-2 bg-white border border-gray-200 rounded-xl px-4 py-3 transition-all focus-within:ring-1 focus-within:ring-[#29258D] focus-within:border-[#29258D]">
                                                <span className="text-gray-400 text-sm font-bold">$</span>
                                                <input
                                                    type="number"
                                                    className="w-full bg-transparent text-base font-mono font-bold text-right focus:outline-none text-gray-900 placeholder:text-gray-300"
                                                    placeholder="0.00"
                                                    value={item.amount || ""}
