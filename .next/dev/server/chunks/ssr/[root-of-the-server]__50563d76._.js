...
/* __next_internal_action_entry_do_not_use__ [{"40bf77b8b06c7c35d2a5123ed19796caadf83ecc89":"createMonthlyBudget","605caea99e2d4dad4cdb908fb6ff993d5fe5bb080a":"updateMonthlyBudget"},"",""] */ __turbopack_context__.s([
    "createMonthlyBudget",
    ()=>createMonthlyBudget,
    "updateMonthlyBudget",
    ()=>updateMonthlyBudget
...
;
;
async function createMonthlyBudget(data) {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["auth"])();
    if (!session?.user?.id) throw new Error("Unauthorized");
    const totalAmount = data.items.reduce((sum, item)=>sum + item.amount, 0);
    try {
        const budget = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].monthlyBudget.create({
            data: {
                userId: session.user.id,
                month: data.month,
                year: data.year,
        ...
        const { approvalWorkflow } = await __turbopack_context__.A("[project]/src/lib/approval-workflow.ts [app-rsc] (ecmascript, async loader)");
        const route = await approvalWorkflow.determineRoute(session.user.id, totalAmount, "Budget Plan", false, "BUDGET", userRegionId || undefined);
        ...
        return {
            error: e.message || "Failed to create monthly budget"
        };
    }
}
async function updateMonthlyBudget(budgetId, data) {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["auth"])();
    if (!session?.user?.id) throw new Error("Unauthorized");
    try {
        const existingBudget = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].monthlyBudget.findUnique({
            where: {
                id: budgetId
            },
            select: {
        ...
        if (existingBudget.status !== "PENDING") return {
            error: "Only pending budgets can be edited"
        };
        ...
        if (existingBudget.userId !== session.user.id && !isAdmin) {
            return {
                error: "Unauthorized to edit this budget"
            };
        }
        const totalAmount = data.items.reduce((sum, item)=>sum + item.amount, 0);
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].$transaction(async (tx)=>{
            ...
            const { approvalWorkflow } = await __turbopack_context__.A("[project]/src/lib/approval-workflow.ts [app-rsc] (ecmascript, async loader)");
            const route = await approvalWorkflow.determineRoute(existingBudget.userId, totalAmount, "Budget Plan", false, "BUDGET", userRegionId || undefined);
        ...
        return {
            error: e.message || "Failed to update monthly budget"
        };
    }
}
;
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(createMonthlyBudget, "40bf77b8b06c7c35d2a5123ed19796caadf83ecc89", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateMonthlyBudget, "605caea99e2d4dad4cdb908fb6ff993d5fe5bb080a", null);
}),
"[project]/.next-internal/server/app/dashboard/requisitions/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/dashboard/requisitions/new/multi-item-actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/app/dashboard/requisitions/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/actions/vendors.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/app/actions/customers.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/src/app/dashboard/requisitions/budget-actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2f$requisitions$2f$budget$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/dashboard/requisitions/budget-actions.ts [app-rsc] (ecmascript)");
;
;
;
;
...
__turbopack_context__.s([
    ...
    "4056bc53f0d80d8629f0dd5dfc17637703ec641596",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2f$requisitions$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fulfillRequisition"],
    ...
    "40e1e69edab14277e88444f56cefc0388179236fe3",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2f$requisitions$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateRequisition"],
    "605caea99e2d4dad4cdb908fb6ff993d5fe5bb080a",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2f$requisitions$2f$budget$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateMonthlyBudget"],
...
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$dashboard$2f$requisitions$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$dashboard$2f$requisitions$2f$new$2f$multi$2d$item$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$src$2f$app$2f$dashboard$2f$requisitions$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$src$2f$app$2f$actions$2f$vendors$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$src$2f$app$2f$actions$2f$customers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE4__$3d3e$__$225b$project$5d2f$src$2f$app$2f$dashboard$2f$requisitions$2f$budget$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/dashboard/requisitions/page/actions.js { ACTIONS_MODULE0 => "[project]/src/app/dashboard/requisitions/new/multi-item-actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/src/app/dashboard/requisitions/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/src/app/actions/vendors.ts [app-rsc] (ecmascript)", ACTIONS_MODULE3 => "[project]/src/app/actions/customers.ts [app-rsc] (ecmascript)", ACTIONS_MODULE4 => "[project]/src/app/dashboard/requisitions/budget-actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2f$requisitions$2f$new$2f$multi$2d$item$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/dashboard/requisitions/new/multi-item-actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2f$requisitions$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/dashboard/requisitions/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$vendors$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/actions/vendors.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$customers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/actions/customers.ts [app-rsc] (ecmascript)");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__50563d76._.js.map