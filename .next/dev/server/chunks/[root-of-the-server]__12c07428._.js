...
async function GET(req) {
    try {
        ...
        if (user.role === "SYSTEM_ADMIN" || user.role === "TEAM_LEADER" || user.role === "REGIONAL_MANAGER") {
            const pendingApprovalsCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].approval.count({
                where: {
                    status: 'PENDING',
            ...
            if (user.role === 'SYSTEM_ADMIN') {
                const pendingExpenses = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].expense.count({
                    where: {
                        status: 'APPROVED',
                        isReimbursable: true,
                        paymentId: null
                ...
                const pendingRequisitions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].requisition.count({
                    where: {
                        status: 'APPROVED',
                        paymentId: null
                    }
                });
                const pendingInvoices = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].invoice.count({
                    where: {
                        status: 'APPROVED',
                        paymentStatus: {
                            not: 'PAID'
        ...
        if (countOnly) {
            const unreadCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].notification.count({
                where: {
                    userId: user.id,
                    isRead: false
                }
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                count: unreadCount + dynamicUnreadCount
            });
        }
        // Get all notifications (last 50)
        const dbNotifications = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].notification.findMany({
            where: {
                userId: user.id
            },
            orderBy: {
...
async function PATCH(req) {
    try {
        ...
        if (markAllRead) {
            // Mark all as read
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].notification.updateMany({
                where: {
                    userId: user.id,
                    isRead: false
                },
        ...
        if (notificationId) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].notification.update({
                where: {
                    id: notificationId,
                    userId: user.id
                },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__12c07428._.js.map