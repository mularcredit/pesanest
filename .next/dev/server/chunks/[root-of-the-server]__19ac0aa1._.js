...
async function GET() {
    ...
    const regions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].region.findMany({
        where: {
            isActive: true
        },
        include: {
...
async function POST(request) {
    ...
    try {
        const region = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].region.create({
            data: {
                name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__19ac0aa1._.js.map