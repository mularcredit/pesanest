...
async function GET(request) {
    ...
    if (user.role === "REGIONAL_MANAGER") {
        const rm = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
            where: {
                id: user.id
            },
            select: {
    ...
    const branches = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].branch.findMany({
        where: whereClause,
        include: {
            region: {
                select: {
...
async function POST(request) {
    ...
    if (!name || !code || !regionId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Name, code, and regionId are required"
        }, {
            status: 400
        });
    }
    try {
        const branch = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].$transaction(async (tx)=>{
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].branch.findUnique({
            where: {
                id: branch.id
            },
            include: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4967ee36._.js.map