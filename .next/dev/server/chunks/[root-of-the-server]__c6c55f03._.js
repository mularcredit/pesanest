...
async function GET(req) {
    try {
        ...
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].systemSetting.findMany({
            where: {
                key: {
                    in: keyArray
                }
...
async function POST(req) {
    try {
        ...
        for (const update of updates){
            ...
            const setting = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].systemSetting.upsert({
                where: {
                    key
                },
                update: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c6c55f03._.js.map