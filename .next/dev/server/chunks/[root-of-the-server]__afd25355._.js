...
"[project]/src/app/api/workflow/analytics/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        }, 0) / completedApprovals.length / (1000 * 60 * 60) : 0;
        ...
        const byCategory = approvals.filter((a)=>a.expense).reduce((acc, a)=>{
        ...
        const dailyTrend = last7Days.map((date)=>{
            ...
            const dayApprovals = approvals.filter((a)=>a.createdAt >= date && a.createdAt < nextDay);
            return {
        ...
        const overdueApprovals = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].approval.findMany({
            where: {
                ...scope === 'personal' ? {
                    approverId: session.user.id
                } : {},
        ...
        if (scope === 'system') {
            ...
            topApprovers = Object.values(approverStats).map((stats)=>({
                    name: stats.name,
                    role: stats.role,
                    total: stats.total,
                    approved: stats.approved,
                    approvalRate: stats.total > 0 ? stats.approved / stats.total * 100 : 0,
                    avgResponseTime: stats.times.length > 0 ? stats.times.reduce((a, b)=>a + b, 0) / stats.times.length : 0
...
//# sourceMappingURL=%5Broot-of-the-server%5D__afd25355._.js.map