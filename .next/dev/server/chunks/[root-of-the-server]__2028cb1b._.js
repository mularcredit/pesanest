...
"[project]/src/app/api/payments/action/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (action === 'DISBURSE' && payment.status !== 'AUTHORIZED') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Payment must be authorized before disbursement'
            }, {
                status: 400
            });
        }
        if (action === 'CLOSE' && payment.status !== 'PAID') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Payment must be disbursed before closing'
            }, {
                status: 400
            });
        }
        if ((action === 'AUTHORIZE' || action === 'REJECT') && payment.status !== 'PENDING_AUTHORIZATION') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Payment is not pending authorization'
            }, {
                status: 400
            });
        }
        // Prevent Maker from checking their own work (optional but good practice)
        if (payment.makerId === session.user.id && ("TURBOPACK compile-time value", "development") === 'production') {
        ...
        if (action === 'AUTHORIZE') {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].payment.update({
                where: {
                    id: paymentId
                },
                data: {
            ...
            if (!p.requisitions || p.requisitions.length === 0) {
                p.requisitions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].requisition.findMany({
                    where: {
                        paymentId
                    }
                });
            ...
            if (!p.monthlyBudgets || p.monthlyBudgets.length === 0) {
                p.monthlyBudgets = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].monthlyBudget.findMany({
                    where: {
                        paymentId
                    }
                });
            ...
            if (paymentMethod === 'WALLET') {
                ...
                if (!wallet || wallet.balance < payment.amount) {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                        error: 'Insufficient wallet balance to cover this disbusment.'
                    }, {
                        status: 400
                    });
                }
                // Deduct balance and record transaction
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].wallet.update({
                    where: {
                        id: wallet.id
                    },
                    data: {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].walletTransaction.create({
                    data: {
                        walletId: wallet.id,
                        userId: session.user.id,
                        type: 'PAYOUT',
            ...
            if (p.expenses.length > 0) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].expense.updateMany({
                    where: {
                        id: {
                            in: p.expenses.map((e)=>e.id)
                        }
                    },
                    data: {
                        status: 'PAID',
            ...
            if (p.requisitions?.length > 0) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].requisition.updateMany({
                    where: {
                        id: {
                            in: p.requisitions.map((r)=>r.id)
                        }
                    },
                    data: {
                        status: 'PAID'
                ...
                if (cashAccount) {
                    for (const req of p.requisitions){
                        try {
                            await AccountingEngine.postRequisitionPayment(req.id, cashAccount.id);
                        } catch (error) {
            ...
            if (p.monthlyBudgets?.length > 0) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].monthlyBudget.updateMany({
                    where: {
                        id: {
                            in: p.monthlyBudgets.map((b)=>b.id)
                        }
                    },
                    data: {
                        status: 'PAID'
                ...
                if (cashAccount) {
                    for (const bud of p.monthlyBudgets){
                        try {
                            await AccountingEngine.postBudgetDisbursement(bud.id, cashAccount.id);
                        } catch (error) {
            ...
            if (p.invoices.length > 0) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].invoice.updateMany({
                    where: {
                        id: {
                            in: p.invoices.map((i)=>i.id)
                        }
                    },
                    data: {
                        status: 'PAID',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2028cb1b._.js.map