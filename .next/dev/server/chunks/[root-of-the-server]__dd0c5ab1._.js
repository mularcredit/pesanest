...
"[project]/src/app/api/accounting/credit-notes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const { customerId, amount, invoiceRef, reason, saleId, date, cnNumber: customCnNumber } = body;
        // Validation
        ...
        if (trimmedCustomCnNumber) {
            ...
            const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].creditNote.findUnique({
                where: {
            ...
            const creditNotes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].creditNote.findMany({
                where: {
                    cnNumber: {
                        startsWith: 'CN-'
                    }
            ...
            while(!isUnique){
                ...
                const collision = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].creditNote.findUnique({
                    where: {
                        cnNumber
                    }
                });
        ...
        const creditNote = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].creditNote.create({
            data: {
                cnNumber,
                customerId,
        ...
        if (sale && sale.customerId === customerId) {
            ...
            const cns = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].creditNote.findMany({
                where: {
        ...
        try {
            ...
            let salesReturnsAccount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].account.findUnique({
                where: {
                    code: '4100'
                }
            });
            if (!salesReturnsAccount) {
                salesReturnsAccount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].account.create({
                    data: {
                        code: '4100',
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(creditNote, {
            status: 201
        });
    } catch (error) {
...
async function GET(req) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(creditNotes);
    } catch (error) {
...
async function PATCH(req) {
    try {
        ...
        const updatedCreditNote = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].creditNote.update({
            where: {
                id
            },
            data: {
        ...
        const sale = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].sale.findUnique({
            where: {
                invoiceNumber: creditNote.invoiceRef
            },
            include: {
                payments: true
            }
        ...
        try {
            const arAccount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].account.findUnique({
                where: {
                    code: '1200'
                }
            });
            const salesReturnsAccount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].account.findUnique({
                where: {
                    code: '4100'
                }
            });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedCreditNote);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dd0c5ab1._.js.map