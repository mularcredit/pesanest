...
"[project]/src/app/api/accounting/accounts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        const accounts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].account.findMany({
            orderBy: [
                {
                    code: 'asc'
                }
...
async function POST(req) {
    ...
    try {
        const account = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].account.create({
            data: {
                code: body.code,
                name: body.name,
                type: body.type,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f311bde._.js.map